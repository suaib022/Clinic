              ...
              <div className="col-lg-4 col-md-6 mx-auto">
                ...
                <div className="booking-wrapper" style={{ padding: "40px", backgroundColor: "#fff", borderRadius: "10px", boxShadow: "0px 0px 20px rgba(1, 41, 112, 0.1)" }}>
                  <div className="booking-header text-center mb-4">
                    ...
                    <p className="text-muted small">Enter your email & password to login</p>
                  </div>
                    ...
                    <form action="#" method="post" className="php-email-form">
                      <div className="row gy-4">
                        ...
                        <div className="col-12 mt-4">
                          <button type="submit" className="btn-book" style={{ width: "100%", padding: "12px 20px", border: "none", borderRadius: "4px", background: "var(--accent-color)", color: "#fff", fontWeight: "600" }}>Login</button>
                        </div>
                        
                        <div className="col-12 text-center mt-3">
                          <p className="small mb-0">Don't have an account? <Link href="/signup" style={{ color: "var(--accent-color)", fontWeight: "600" }}>Sign up</Link></p>
                        </div>
                      </div>
                    </form>
                  </div>
